        ...
        <form action="/farmer" method="get">
            <div class="row mb-3">
                ...
                <div class="col-12 col-md-6 col-lg-2 mb-2">
                    ...
                    <input type="number" step="0.01" class="form-control" id="initial_value" name="initial_value" value="<?= isset($params['initial_value']) ? $params['initial_value'] : null ?>">
                </div>

                <div class="col-12 col-md-6 col-lg-2 mb-2">
                    <label for="final_value" class="form-label">Final value</label>
                    <input type="number" step="0.01" class="form-control" id="final_value" name="final_value" value="<?= isset($params['final_value']) ? $params['final_value'] : null ?>">
                </div>
